  ...
  let dmx = 0, dmy = 0; // "Dirty" check coordinates
  ...
  function animateCursor() {
    ...
    const moved = Math.abs(mx - dmx) > 0.1 || Math.abs(my - dmy) > 0.1 || Math.abs(rx - dmx) > 0.1 || Math.abs(ry - dmy) > 0.1;
  ...
  // Use event delegation for hover states to support dynamic content and reduce listeners
