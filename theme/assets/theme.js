  ...
  // Optimized mousemove: only update coordinates, use passive listener
  document.addEventListener('mousemove', e => {
    mx = e.clientX;
    my = e.clientY;
  }, { passive: true });

  // Consolidated rAF loop for all cursor animations
  function animateCursor() {
    ...
    // Dirty check: only update DOM if movement > 0.1px to reduce layout work
