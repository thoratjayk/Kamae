  ...
  // Track mouse with passive listener for performance
  ...
  function animateCursor() {
    ...
    // Performance: Only update DOM if movement > 0.1px (avoids redundant writes when stationary)
  ...
  // Event delegation for cursor hover state (supports dynamic elements + lower memory)
