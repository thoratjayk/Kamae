  ...
  function animateCursor() {
    // Smoother interpolation for both dot and ring
    dx += (mx - dx) * 0.35;
    dy += (my - dy) * 0.35;
    rx += (mx - rx) * 0.12;
    ry += (my - ry) * 0.12;

    // Use a 0.1px threshold to avoid redundant DOM updates when stationary
  ...
  // Use event delegation for hover states to improve performance and support dynamic content
