  ...
  // Only update coordinates on mousemove to keep it lightweight
  ...
  function animateCursor() {
    ...
    // Smooth interpolation for dot (slight delay for better feel)
    dx += (mx - dx) * 0.35;
    dy += (my - dy) * 0.35;

    // Performance: Only update DOM if change is > 0.1px (dirty check)
  ...
  // Document-level event delegation for hover states (performance & handles dynamic elements)
