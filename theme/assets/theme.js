  ...
  /**
   * Consolidated animation loop for the custom cursor.
   * Uses translate3d to leverage GPU acceleration and avoid layout thrashing.
   */
  ...
  // Use event delegation for hover states to reduce memory overhead and handle dynamic elements
  document.addEventListener('mouseover', e => {
    const isInteractive = e.target.closest('a, button, [onclick], .product-add-btn');
