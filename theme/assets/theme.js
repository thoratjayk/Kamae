  ...
  // Optimized cursor movement using passive listener
  ...
  function animateCursor() {
    // ⚡ Bolt: Consolidated animation loop with "dirty-check" threshold
    ...
    // Only update DOM if movement is above 0.1px threshold (prevents redundant updates)
  ...
  // ⚡ Bolt: Using event delegation for hover effects (supports dynamic elements + less memory)
