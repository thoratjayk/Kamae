  ...
  // Performance: Track coordinates only, defer all DOM updates to rAF loop
  document.addEventListener('mousemove', e => { mx = e.clientX; my = e.clientY; }, { passive: true });
  // Consolidated animation loop to reduce layout thrashing and leverage GPU via translate3d
  ...
  animateCursor();
  // Efficient event delegation: O(1) listener vs O(N) for hover effects
