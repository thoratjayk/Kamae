  /* ── CURSOR ── */
  // Optimized: Consolidated positioning into a single rAF loop with translate3d for GPU acceleration.
  // Using event delegation for hover states to improve memory efficiency and support dynamic content.
  ...
  function animateCursor() {
    rx += (mx - rx) * 0.12;
    ry += (my - ry) * 0.12;
    // Update both elements in one frame to ensure they stay synced and use hardware acceleration
