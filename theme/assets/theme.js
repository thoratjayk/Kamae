  ...
  // Track mouse position with passive listener for performance
  ...
  function animateCursor() {
    // Interpolate positions (0.35 for dot, 0.12 for ring)
    dx += (mx - dx) * 0.35;
    dy += (my - dy) * 0.35;
    rx += (mx - rx) * 0.12;
    ry += (my - ry) * 0.12;

    // Performance: Only update DOM if movement exceeds 0.1px threshold (dirty check)
  ...
  // Performance: Use event delegation for hover states to handle dynamic elements and reduce listener count
