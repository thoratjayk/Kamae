  ...
  // Use passive listener to avoid blocking the main thread and only update coordinates
  document.addEventListener('mousemove', e => { mx = e.clientX; my = e.clientY; }, { passive: true });
  function animateCursor() {
    // Consolidate DOM updates in a single rAF loop and use translate3d for GPU acceleration
  ...
  animateCursor();
  // Use event delegation for better performance and to handle dynamic elements (like products)
